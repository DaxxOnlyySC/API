...
async def cmds_cmd(ctx):
    ...
    embed.add_field(name=f"{PREFIX}whitelist <uid>", value="Add/remove whitelist [Owner]", inline=False)
...
def main():
    print("=" * 50)
    print("  LuaExec Discord Bot v2.0 (Merged)")
    print("  Lua pipe + Cloudflare API")
    print("=" * 50)
    connect_pipes()
    bot.run(TOKEN)
